...
type ObjectDB interface {
	...
	Store(ctx context.Context, object obj.Object) error
	// GetObjectByID will retrieve the object with the provided ID.
	GetObjectByID(ctx context.Context, id string) (obj.Object, error)
	// GetObjectByName will retrieve the object with the given name.
	GetObjectByName(ctx context.Context, name string) (obj.Object, error)
	// ListObjects will return a list of all objects of the given kind.
	ListObjects(ctx context.Context, kind string) ([]obj.Object, error)
...
func (db *DB) Store(ctx context.Context, object obj.Object) error {
...
func (db *DB) GetObjectByID(ctx context.Context, id string) (obj.Object, error) {
...
func (db *DB) ListObjects(ctx context.Context, kind string) ([]obj.Object, error) {
